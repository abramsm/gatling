 ...
 */
abstract class RequestAction[C <: Check[R, _], R, P <:ProtocolConfiguration](next: ActorRef, request: Request, givenProcessors: Option[List[CheckWithVerifyBuilder[C, R, _]]], protocolConfiguration: Option[P]) extends Action {
